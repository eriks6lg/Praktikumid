...
public class HighLowWithImages extends JPanel {
    ...
    private class CardPanel extends JPanel implements ActionListener {
        ...
        Deck1 deck;       // A deck of cards to be used in the game.
        ...
        void doHigher() {
            ...
            Card1 thisCard = hand.getCard( cardCt - 1 );  // Card just dealt.
            Card1 prevCard = hand.getCard( cardCt - 2 );  // The previous card.
        ...
        void doNewGame() {
            ...
            deck = new Deck1();   // Create the deck and hand to use for this game.
            hand = new Hand();
            deck.shuffle();
         ...
         */
        public void drawCard(Graphics g, Card1 card, int x, int y) {
