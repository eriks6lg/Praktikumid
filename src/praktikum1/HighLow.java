...
public class HighLow {
    ...
    private static int play() {
        ...
        Deck1 deck = new Deck1();  // Get a new deck of cards, and 
                                 //   store a reference to it in 
                                //   the variable, deck.

        Card1 currentCard;  // The current card, which the user sees.

        Card1 nextCard;   // The next card in the deck.  The user tries
